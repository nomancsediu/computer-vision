...
```
Layer 1: 28×28 → 26×26  (2 কমেছে)
Layer 2: 26×26 → 24×24  (2 কমেছে)
Layer 3: 24×24 → 22×22  (2 কমেছে)
Layer 4: 22×22 → 20×20  (2 কমেছে)
Layer 5: 20×20 → 18×18  (2 কমেছে)
...
Layer 10: 10×10 → 8×8
Layer 11: 8×8 → 6×6
Layer 12: 6×6 → 4×4
...
```
Kernel 3×3 → Padding = (3 - 1) / 2 = 1  (প্রতি side এ 1 row/column zero যোগ)
Kernel 5×5 → Padding = (5 - 1) / 2 = 2  (প্রতি side এ 2 row/column zero যোগ)
Kernel 7×7 → Padding = (7 - 1) / 2 = 3  (প্রতি side এ 3 row/column zero যোগ)
```
...
# Valid padding মডেল (কোনো padding নেই)
...
# Same padding মডেল (zero padding যোগ হচ্ছে)
